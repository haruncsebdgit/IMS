...
CREATE TABLE `access_logs` (
  ...
  `login_ip` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `login_datetime` datetime NOT NULL,
  `logout_datetime` datetime DEFAULT NULL,
  `user_agent` text CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `common_labels` (
  ...
  CONSTRAINT `common_labels_organization_id_foreign` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `employees_designation_id_foreign` FOREIGN KEY (`designation_id`) REFERENCES `common_labels` (`id`),
  CONSTRAINT `employees_employee_category_id_foreign` FOREIGN KEY (`employee_category_id`) REFERENCES `common_labels` (`id`),
  CONSTRAINT `employees_employee_class_id_foreign` FOREIGN KEY (`employee_class_id`) REFERENCES `common_labels` (`id`),
  CONSTRAINT `employees_employee_type_id_foreign` FOREIGN KEY (`employee_type_id`) REFERENCES `common_labels` (`id`),
...
CREATE TABLE `inv_item_return_on_supports` (
  ...
  CONSTRAINT `inv_item_return_on_supports_inventory_cost_center_foreign` FOREIGN KEY (`inventory_cost_center`) REFERENCES `organograms` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `inv_item_return_on_supports_organization_id_foreign` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `inv_item_return_on_supports_supplier_vendor_foreign` FOREIGN KEY (`supplier_vendor`) REFERENCES `inv_suppliers` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(19,'2021-08-01',65,'2021-08-01',NULL,1,1,0,2,1,NULL,3,NULL,'2021-08-01 21:30:41','2021-08-01 21:32:06');
...
(1,'dept_cse',NULL,1,1,NULL,3,'2021-07-23 11:52:19','2021-07-31 11:21:53'),
(8,'dept_cse',2,1,1,65,1,'2021-07-31 11:21:53','2021-07-31 11:21:53');
...
CREATE TABLE `inv_suppliers` (
  ...
  CONSTRAINT `inv_suppliers_organization_id_foreign` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `inv_suppliers_tender_id_foreign` FOREIGN KEY (`tender_id`) REFERENCES `procurement_tenderers` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `roles_permissions` (
  ...
  CONSTRAINT `roles_permissions_organization_id_foreign` FOREIGN KEY (`organization_id`) REFERENCES `organizations` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1,NULL,'external','Inventory Manager','Inventory Manager','admin','admin@mail.com',NULL,'$2y$10$bggGuSSSrrAHGt8iLbrqcekAculoPNSIwBzqoTUmsni1psmzMpaDG',NULL,NULL,'House-4, Road No-9/B, Nikunja-1',NULL,NULL,NULL,'super_admin','user/2025-02/user-avatar-1739458403.png',1,'2021-04-05 05:35:53','2025-02-13 20:53:23'),
(2,NULL,NULL,'Dr. Md. Habibur Rahman','Dr. Md. Habibur Rahman','kamal','habibiucse@iu.ac.bd',NULL,'$2y$10$U4SHsO3patrvoLg6WTXR1eOtqYfPKI6uQF7dA89Z.l1yg7OxtPqLG',NULL,NULL,'House-4, Road No-9/B, Nikunja-2',NULL,6,65,NULL,NULL,1,'2021-07-24 11:26:55','2025-02-13 22:48:21'),
(3,NULL,NULL,'Department Chairman','Department Chairman','dept_chairman','cseiu@iu.ac.bd',NULL,'$2y$10$0MSUCbfVFv2aceYdMm6dJujm/4MSp.rK4Xwy0NxWr2hPjABBUhYka',NULL,NULL,NULL,NULL,53,66,NULL,NULL,1,'2021-07-30 18:23:32','2025-02-13 22:43:17');
