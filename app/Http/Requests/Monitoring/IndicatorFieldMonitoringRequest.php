...
class IndicatorFieldMonitoringRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'monitoring_date.required'      => __('Monitoring Date is Required field.'),
            'cig_id.required'               => __('Please select CIG.')
        ];
    }
}
