...
class InvItemOnSupportReturnFromSupplierVendorInformation extends Model
{
    use HasFactory;
    protected $table = 'inv_item_on_support_return_from_supplier_vendor_information';
    ...
    protected $fillable = [
        'organization_id','receive_date', 'inventory_cost_center',
        'supplier_vendor', 'return_from_remarks' , 'on_support_id',
    ...
    public function ivnReturnFromItemInfo()
    {
        return $this->hasMany(InvReturnFromItemInfo::class, 'return_from_item_id' , 'id');
    }
    ...
    public static function getAll($args = array(), $id = null)
    {
        ...
        $item_on_support_return_from_supplier_vendor_information = InvItemOnSupportReturnFromSupplierVendorInformation::query()
            ->leftJoin('users AS u', 'inv_item_on_support_return_from_supplier_vendor_information.created_by', '=', 'u.id')
            ->leftJoin('organograms AS o', 'inv_item_on_support_return_from_supplier_vendor_information.inventory_cost_center', '=', 'o.id')
            ->leftJoin('inv_return_item_infos AS i', 'inv_item_on_support_return_from_supplier_vendor_information.id', '=', 'i.return_item_id')
            ->select(
                'inv_item_on_support_return_from_supplier_vendor_information.*',
                "u.$name AS user_name",
        ...
        if (!is_null($id)) {
            $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->where('item_on_support_return_from_supplier_vendor_information.id', $id);
        }
        ...
        foreach ($arguments['order'] as $orderBy => $order) {
            $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->orderBy($orderBy, $order);
        }

        if ($arguments['items_per_page'] == '-1') {
            $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->get();
        } else {
            if (true == $arguments['paginate']) {
                $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->paginate(intval($arguments['items_per_page']));
            } else {
                $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->take(intval($arguments['items_per_page']));
                $item_on_support_return_from_supplier_vendor_information = $item_on_support_return_from_supplier_vendor_information->get();
            }
        }

        return $item_on_support_return_from_supplier_vendor_information;
    }
    public static function getMasterData($item_on_support_return_from_supplier_vendor_information = null)
    {
    ...
    public static function saveOrUpdate($request, $id = null)
    {
        ...
        if (is_null($id)) {
            ...
            $item_on_support_return_from_supplier_vendor_information = InvItemOnSupportReturnFromSupplierVendorInformation::create($requestData);
        } else {
            ...
            $item_on_support_return_from_supplier_vendor_information->update($requestData);
        }

        InvReturnFromItemInfo::saveReturnFromItemInfo($request->all(), $item_on_support_return_from_supplier_vendor_information->id);
        }
}
