...
class CreateInfertilityCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('infertility_campaigns', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->integer('cattle_buffalo_diagnosed_examined')->nullable();
            $table->integer('cattle_buffalo')->nullable();
            $table->integer('cattle_buffalo_prescribed')->nullable();
    ...
    {
        Schema::dropIfExists('infertility_campaigns');
    }
}
