...
class CreateIndicatorSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('indicator_setups', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->unsignedBigInteger('indicator_sub_category_id');
