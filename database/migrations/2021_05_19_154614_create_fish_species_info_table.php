...
class CreateFishSpeciesInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fish_species', function (Blueprint $table) {
            ...
            $table->enum('fish_culture_type', ['natural', 'stocked', 'cultured']);
            $table->enum('fish_source', ['pond', 'beel', 'river','sea'])->nullable();
            $table->boolean('isSIS')->default(1);
            $table->boolean('isRare')->default(0);
            $table->boolean('isExtinct')->default(0);
