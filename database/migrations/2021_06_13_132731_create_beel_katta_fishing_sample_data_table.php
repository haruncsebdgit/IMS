...
class CreateBeelKattaFishingSampleDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('beel_katta_fishing_sample_data', function (Blueprint $table) {
            $table->engine = 'InnoDB';   
    ...
    {
        Schema::dropIfExists('beel_katta_fishing_sample_data');
    }
}
