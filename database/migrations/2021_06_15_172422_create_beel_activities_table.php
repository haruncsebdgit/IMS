...
class CreateBeelActivitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('beel_activities', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->unsignedBigInteger('beel_id')->nullable()->comment("beel Id");
            $table->date('activity_period_date_from')->nullable();
            $table->date('activity_period_date_to')->nullable();
            $table->integer('allocation_amount')->nullable();
            ...
            $table->foreign('beel_id')->references('id')->on('beel')->onUpdate('cascade')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('beel_activities');
    }
}
