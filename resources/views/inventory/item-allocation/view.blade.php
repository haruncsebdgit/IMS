<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {{ displayDateTime($itemAllocation->allocation_date) }}
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {{ resolveFieldName($itemAllocation->user()->first()) }}
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {{ resolveFieldName($itemAllocation->location()->first()) }}
        </div>
    </div>
