...
{{-- display page title --}}
@section('page_title', __('Edit Item On-Support or Return from Supplier/Vendor Information'))
@section('body_class', '')

{{-- display page header --}}
@section('page_header_icon', 'icon-pie-chart5')
@section('page_header', __('Edit Item On-Support or Return from Supplier/Vendor Information'))
@section('sidebar')
...
@php
    ...
    [
        ...
        action('Inventory\ItemOnSupportReturnFromSupplierVendorInformationController@edit')  => __('Edit')
    ];
@endphp
...
@section('breadcrumb_right')
    ...
    @if( hasUserCap('add_item_on_support_return_from_supplier_vendor_information'))
        <a href="{{ action('Inventory\ItemOnSupportReturnFromSupplierVendorInformationController@create') }}" class="btn btn-sm btn-primary">
