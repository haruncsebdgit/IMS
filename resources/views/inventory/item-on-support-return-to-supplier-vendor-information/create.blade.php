...
{{-- display page title --}}
@section('page_title', __('Add Item On-Support or Return to Supplier/Vendor Information'))
@section('body_class', '')

{{-- display page header --}}
@section('page_header_icon', 'icon-vimeo2')
@section('page_header', __('Add Item On-Support or Return to Supplier/Vendor Information'))
@section('sidebar')
...
[
    ...
    action('Inventory\ItemOnSupportReturnToSupplierVendorInformationController@create')  => __('Add New')
];
@endphp
...
<div class="card">
    <div class="card-body">
    {!! Form::open(['action' => ['Inventory\ItemOnSupportReturnToSupplierVendorInformationController@store'], 'files' => true, 'class' => 'needs-validation', 'novalidate']) !!}
