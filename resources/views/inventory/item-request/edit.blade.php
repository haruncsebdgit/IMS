...
{{-- display page title --}}
@section('page_title', __('Edit Request Item'))
@section('body_class', '')

{{-- display page header --}}
@section('page_header_icon', 'icon-cart')
@section('page_header', __('Edit Request Item'))
@section('sidebar')
...
@php
    $breadcrumbs =
    [
        action('Inventory\RequestItemController@index') => __('Item Request Item'),
        action('Inventory\RequestItemController@edit')  => __('Edit')
    ];
@endphp
...
@section('breadcrumb_right')
    ...
    @if( hasUserCap('add_item_request_information'))
        <a href="{{ action('Inventory\RequestItemController@create') }}" class="btn btn-sm btn-primary">
...
<div class="alert alert-info alert-styled-left">
    ...
    <div class="card">
        <div class="card-body">
        {!! Form::model($requestedItem, ['route' => ['request-item.update', $requestedItem->id],'method'=>'put', 'class' => 'needs-validation', 'novalidate']) !!}
