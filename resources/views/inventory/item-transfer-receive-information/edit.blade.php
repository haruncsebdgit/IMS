...
{{-- display page title --}}
@section('page_title', __('Edit Item Transfer Receive Information'))
@section('body_class', '')

{{-- display page header --}}
@section('page_header_icon', 'icon-transmission')
@section('page_header', __('Edit Item Transfer Receive Information'))
@section('sidebar')
...
@php
    ...
    [
        ...
        action('Inventory\ItemTransferReceiveInformationController@edit')  => __('Edit')
    ];
@endphp
...
@section('breadcrumb_right')
    ...
    @if( hasUserCap('add_item_transfer_receive_information'))
        <a href="{{ action('Inventory\ItemTransferReceiveInformationController@create') }}" class="btn btn-sm btn-primary">
...
<div class="alert alert-info alert-styled-left">
    ...
    <div class="card">
        <div class="card-body">
        {!! Form::model($item_transfer_receive_information, ['route' => ['item-transfer-receive-information.update', $item_transfer_receive_information->id],'method'=>'put', 'files' => true, 'class' => 'needs-validation', 'novalidate']) !!}
