...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::text('transfer_receive_remarks', null, ['step'=>'any', 'class' => 'form-control ']) !!}
                </div>
        </div>
 ...
 @include('inventory.item-transfer-receive-information.transfer-receive-item-info-form')
...
@push('scripts')
<script src="{{ asset('js/pages/transfer-receive-item-infos.js') }}"></script>
@endpush